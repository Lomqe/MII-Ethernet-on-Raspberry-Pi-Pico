...
float sensor1_lut_volt[] = {2.45, 2.11, 1.87, 1.65, 1.51, 1.39, 1.13, 0.98, 0.85, 0.75, 0.68, 0.61, 0.58, 0.52, 0.50, 0.47, 0.43, 0.41};
uint8_t sensor1_lut_cm[] = {10, 12, 14, 16, 18, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80};
